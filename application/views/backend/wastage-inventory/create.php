<div class="col-md-12">
	...
	<div class="card mt-0">
		<form method="post" id="createWastageStockForm" class="form-horizontal" enctype="multipart/form-data" action="#">
			<div class="card-header card-header-text">
				<h4 class="card-title"><?=$headTitle?></h4>
			</div>
			<div class="card-content">
				<div class="row col-md-12">
					<span><b>Wastage Stock No: </b><?=WASTAGE_STOCK_SHORT_NAME?>-<?=$wastageStockNumber?><span>

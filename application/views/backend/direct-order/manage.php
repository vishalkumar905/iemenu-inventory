<div class="col-md-12 displaynone" id="manageDirectOrderContainer">
	<div class="card mt-0">
		<div class="card-content">
			...
			<form id="directOrderForm" method="POST">
				<div class="table-responsive">
					<table class="table table-bordered custom-table" cellspacing="0" width="100%" style="width:100%">
						...
						<tbody id="directOrderTableBody"></tbody>
					</table>
				</div>
			</form>
			...
			<div class="toolbar mb-10">
				<div class="row">
					<div class="col-md-12">
						<button type="button" name="submit" value="Save" id="saveDirectOrder" class="btn btn-rose btn-fill">Submit<div class="ripple-container"></div></button>
					</div>
				</div>
			</div>
		</div>

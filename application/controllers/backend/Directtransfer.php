...
class Directtransfer extends Backend_Controller
{
	public $exportUrl;
	...
	public function __construct()
	{
		...
		$this->pageTitle = $this->navTitle = 'Direct Transfer';
	}

	public function index()
	{
		$data['submitBtn']  = 'Save';
		$data['headTitle']  = 'Direct Transfer';
		...
		$data['viewFile'] = 'backend/direct-transfer/index';
